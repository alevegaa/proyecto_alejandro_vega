...
<body>
    ...
    <div class="container custom-container">
        <h2>Editar un taller</h2>
        <form id="formulariotaller" class="justify-content-center" onsubmit="return actualizarTaller()" method="POST">
            <div class="mb-2">
                <label for="id_taller" class="form-label">ID del taller</label>
                <input type="number" class="form-control" id="id_taller" name="id_taller" required autofocus>
            </div>
            <div class="mb-2">
