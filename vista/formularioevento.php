...
<body>
    ...
    <div class="container custom-container">
        ...
        <form id="formularioevento" class="justify-content-center" onsubmit = "return anadirevento()" method="POST">
            <div class="mb-2">
                <label for="nombre_evento" class="form-label">Nombre</label>
                <input type="text" class="form-control" id="nombre_evento" name="nombre_evento" required autofocus>
            </div>
            <div class="mb-2">
            ...
            <button type="submit" class="btn btn-primary custom-btn justify-content-center">Añadir evento</button>
        </form>
    </div>
